...
export type ConsumerDashboard = { email: string; workspaceId: string | null; consent: boolean; authorization: boolean; reports: Array<{ id: string; generatedAt: string; findingCount: number; parserVersion: string; exportId: string | null }> }
