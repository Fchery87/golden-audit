...
- See also `docs/nationwide-legal-regulatory-posture-brief.md`, `docs/competitor-credit-positioning-brief.md`, `docs/product-boundary-positioning-update.md`, `docs/copy-boundary-guide.md`, `docs/50-state-review-tracker.md`, `docs/launch-scope-decision-memo.md`, and `docs/launch-scope-checklist-index.md` for the current analysis-only positioning and state-review posture.
