...
- **Current research posture:** analysis-only improves the argument against credit-repair classification, but does **not** yet establish that a paid nationwide launch is clearly acceptable in all states; see `docs/nationwide-legal-regulatory-posture-brief.md`, `docs/product-boundary-positioning-update.md`, `docs/50-state-review-tracker.md`, and the state memo indexes.
- **Draft artifacts prepared to support those reviews:** `docs/data-flow.md`, `docs/glba-wisp-skeleton.md`, `docs/privacy-notice-draft.md`, `docs/privacy-review-packet.md`, `docs/security-review-packet.md`, `docs/risk-assessment-template.md`, `docs/pilot-approval-review-packet.md`, `docs/legal-review-packet.md`, `docs/approval-handoff-template.md`, `docs/legal-approval-handoff.md`, `docs/privacy-approval-handoff.md`, `docs/security-approval-handoff.md`, `docs/nationwide-legal-regulatory-posture-brief.md`, `docs/competitor-credit-positioning-brief.md`, `docs/product-boundary-positioning-update.md`, `docs/copy-boundary-guide.md`, `docs/50-state-review-tracker.md`, `docs/priority-state-memo-index.md`, `docs/followup-state-memo-index.md`, `docs/remaining-states-consolidated-memo.md`, `docs/launch-scope-decision-memo.md`, `docs/checklist-one-state-free-pilot.md`, `docs/checklist-small-reviewed-state-subset.md`, `docs/checklist-pause-launch-claims.md`, `docs/launch-scope-checklist-index.md`, `docs/one-state-launch-selection-memo.md`, `docs/launch-scope-field-schema.md`, `docs/onboarding-copy-approved-state-pilot.md` (all drafts/research only; none are approved/final).
